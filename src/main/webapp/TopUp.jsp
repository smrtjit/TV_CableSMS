...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="3D1166CE" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
        <div>
...
<!-- 				<li class="pushy-link"><a href="notification.aspx">Notification</a></li> -->
	...
	<tr>
		<td><span class="radio-inline"><input id="ContentPlaceHolder1_rbselect_0" type="radio" name="ctl00$ContentPlaceHolder1$rbselect" value="0" checked="checked" /><label for="ContentPlaceHolder1_rbselect_0">OneToOne_Recharge</label></span></td><td><span class="radio-inline"><input id="ContentPlaceHolder1_rbselect_1" type="radio" name="ctl00$ContentPlaceHolder1$rbselect" value="1" /><label for="ContentPlaceHolder1_rbselect_1">Bulk Recharge</label></span></td>
	</tr>
</table>
		</div>
	</div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtvcmobile" type="text" id="ContentPlaceHolder1_txtvcmobile" tabindex="1" class="form-control" placeholder="VC No" />
            ...
            <div class="col-sm-2">
                <div style="margin-bottom: 10px">
                    ...
                    <input type="submit" name="ctl00$ContentPlaceHolder1$btn_search" value="Submit" id="ContentPlaceHolder1_btn_search" tabindex="12" class="btn-primary btn btn-block" />
