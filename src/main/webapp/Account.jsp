							...
							<div class="col-sm-12">
								...
								<div class="col-sm-8" style="margin-bottom: 10px">
									<input name="ctl00$ContentPlaceHolder1$txtBalance" type="text"
										...
										value="<%=request.getParameter("Account_balance")%>"
							...
							<div class="col-sm-12">
								...
								<div class="col-sm-8" style="margin-bottom: 10px">
									<input name="ctl00$ContentPlaceHolder1$txtDueDate" type="text"
										value="<%=request.getParameter("Last_recharge_date")%>"
								...
								<div class="col-sm-10">
									...
									<div class="col-sm-6" style="margin-bottom: 10px">
										<input name="ctl00$ContentPlaceHolder1$txtvcno" type="text"
											...
											readonly="readonly" id="ContentPlaceHolder1_txtvcno"
											class="form-control" placeholder="" />
									</div>
									<div class="col-sm-2" style="margin-bottom: 10px">
										<input type="submit"
