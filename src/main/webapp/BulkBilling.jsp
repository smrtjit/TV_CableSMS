...
//]]>
		...
		<div>
			...
			<ul>
				...
				<li class="pushy-link"><a href="MyAccount.jsp?user=<%= request.getParameter("user") %>?user=<%= request.getParameter("user") %>">My Account</a></li>
