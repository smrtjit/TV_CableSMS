	...
	<form method="post" action="./myaccount.aspx" id="form1">
		<div class="aspNetHidden">
			<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
				value="URd5WzUveyAlmrzaplEM/vfJtRSADWd4P5Pd4U7cl61pELRHZ7LsvMdXEDoO+ZXAioHieBAX8N3j41gPhMlDE8yCZFKuBczMotHJQ3KH/JI=" />
		</div>

		<div class="aspNetHidden">

			<input type="hidden" name="__VIEWSTATEGENERATOR"
				id="__VIEWSTATEGENERATOR" value="87F71321" /> <input type="hidden"
				name="__EVENTVALIDATION" id="__EVENTVALIDATION"
				value="" />
		</div>
		<div>
				...
				<div class="container">
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$txtDesignation"
									type="text" value="Field Worker" readonly="readonly"
									id="ContentPlaceHolder1_txtDesignation" class="form-control" />
							</div>
							<div class="col-sm-4">
								<p>Name :</p>
							</div>
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox1" type="text"
									value="Kalu" readonly="readonly"
									id="ContentPlaceHolder1_TextBox1" class="form-control" />
							</div>
							<div class="col-sm-4">
								<p>Email Id :</p>
							</div>
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox2" type="text"
									value="kalu@gmail.com" readonly="readonly"
									id="ContentPlaceHolder1_TextBox2" class="form-control" />
							</div>
							<div class="col-sm-4">
								<p>Mobile No. :</p>
							</div>
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox3" type="text"
									value="57345634423" readonly="readonly"
									id="ContentPlaceHolder1_TextBox3" class="form-control" />
							</div>
							<div class="col-sm-4">
								<p>Landline No. :</p>
							</div>
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox4" type="text"
									value="022-23423412" readonly="readonly"
									id="ContentPlaceHolder1_TextBox4" class="form-control" />
							</div>
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							...
							<div class="col-sm-8" style="margin-bottom: 5px">
								<textarea name="ctl00$ContentPlaceHolder1$TextBox5" rows="2"
									cols="20" readonly="readonly" id="ContentPlaceHolder1_TextBox5"
									class="form-control">
Noida UP </textarea>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox7" type="text"
									value="PAN No." readonly="readonly"
									id="ContentPlaceHolder1_TextBox7" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="col-sm-4">
							...
							<div class="col-sm-8" style="margin-bottom: 5px">
								<textarea name="ctl00$ContentPlaceHolder1$TextBox6" rows="2"
									cols="20" readonly="readonly" id="ContentPlaceHolder1_TextBox6"
									class="form-control">
A-453 New Ashok Nagar</textarea>
							</div>
							<div class="col-sm-4">
								<p>Address Proof. :</p>
							</div>
							<div class="col-sm-8" style="margin-bottom: 5px">
								<input name="ctl00$ContentPlaceHolder1$TextBox8" type="text"
									value="Rashan Card" readonly="readonly"
									id="ContentPlaceHolder1_TextBox8" class="form-control" />
							</div>
						</div>
					</div>
				</div>
