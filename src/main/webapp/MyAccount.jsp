    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtcode" type="text" value="123456780" readonly="readonly" id="ContentPlaceHolder1_txtcode" class="form-control" />
                </div>
            </div>
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtname" type="text" value="Harish" readonly="readonly" id="ContentPlaceHolder1_txtname" class="form-control" />
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtloginid" type="text" value="Vishwakarma001" readonly="readonly" id="ContentPlaceHolder1_txtloginid" class="form-control" />
                </div>
                <div class="col-sm-3" style="margin-bottom: 10px">
                    <p class="p1">Middle Name</p>
                </div>
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtmname" type="text" value="Kumar" readonly="readonly" id="ContentPlaceHolder1_txtmname" class="form-control" />
                </div>
                <div class="col-sm-3" style="margin-bottom: 10px">
                    <p class="p1">JV No.</p>
                </div>
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtjvno" type="text" value="4563452346" readonly="readonly" id="ContentPlaceHolder1_txtjvno" class="form-control" />
                </div>
            </div>
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtfname" type="text" value="Pramod" readonly="readonly" id="ContentPlaceHolder1_txtfname" class="form-control" />
                </div>
                <div class="col-sm-3" style="margin-bottom: 10px">
                    <p class="p1">Last Name</p>
                </div>
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtlname" type="text" value="Vishwakarma" readonly="readonly" id="ContentPlaceHolder1_txtlname" class="form-control" />
                </div>
                <div class="col-sm-3" style="margin-bottom: 10px">
                    <p class="p1">Direct No.</p>
                </div>
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtdirectno" type="text" value="9559404556" readonly="readonly" id="ContentPlaceHolder1_txtdirectno" class="form-control" />
                </div>
        ...
        <div class="col-sm-12">
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtpoid" type="text" value="56780" readonly="readonly" id="ContentPlaceHolder1_txtpoid" class="form-control" />
                </div>
            </div>
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtaccount" type="text" value="000032344632536462" readonly="readonly" id="ContentPlaceHolder1_txtaccount" class="form-control" />
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtmobile" type="text" value="9559404556" readonly="readonly" id="ContentPlaceHolder1_txtmobile" class="form-control" />
                </div>
            </div>
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8">
                    <input name="ctl00$ContentPlaceHolder1$txtemail" type="text" value="pramod.xpx@gmail.com" readonly="readonly" id="ContentPlaceHolder1_txtemail" class="form-control" />
                </div>
            </div>
        </div>
...
E7 Kailash Colony New Delhi</textarea>
                </div>
	...
	<option value="0">West Bengal</option>
            ...
            <div class=" col-sm-5">
                ...
                <div class="col-sm-8" style="margin-bottom: 10px">
                    <input name="ctl00$ContentPlaceHolder1$txtcity" type="text" value="Bengal" readonly="readonly" id="ContentPlaceHolder1_txtcity" class="form-control" />
                </div>
