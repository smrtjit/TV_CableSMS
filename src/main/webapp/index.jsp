...
body {
	height: 100%;
	margin: 0;
	background: url(assets/img/cabletv.jpg);
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to TV Cable Operator System!</h1>
			...
			<a class="btn btn-primary" href="userlogin.html">Operator Login » </a> 
			<a class="btn btn-primary" href="login.html">Customer Login » </a>
		</div>
